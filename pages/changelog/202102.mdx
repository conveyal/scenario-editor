...
- Freeform (non-grid) pointsets can be used as origins and destinations in regional travel time and accessibility calculations. Travel time matrices and other related features require the latest routing engine (v6.1.1).
