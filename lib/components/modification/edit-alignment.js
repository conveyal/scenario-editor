        ...
        {isEditing &&
          <section className='panel panel-default inner-panel'>
            ...
            <div className='panel-body'>
              ...
              <p>Click on a segment to create a stop at that location.</p>
              <p>Click on a stop to delete it or change it into a control point. Control points can be used to help position the routes.</p>
              <p>Click or drag an auto-created stop to turn it into a permanent stop.</p>
              <p><strong>Symbology</strong></p>
              <p><Icon type='circle-o' style={{color: GTFS_STOP_COLOR, opacity: 0.5}} /> Existing stops from GTFS Feed</p>
              <p><Icon type='circle-o' style={{color: NEW_STOP_COLOR}} /> A new stop.</p>
              <p><Icon type='circle-o' style={{color: NEW_STOP_COLOR, opacity: 0.5}} /> An auto-created stop.</p>
              <p><Icon type='circle-o' style={{color: NEW_SNAPPED_STOP_COLOR}} /> A new stop snapped to an existing stop.</p>
              <span><Icon type='circle' style={{color: CONTROL_POINT_COLOR}} /> Control point for a segment.</span>
            </div>
          </section>}
      </div>
    )
