...
To calculate the color breaks for a Regional Analysis we use the [CKMeans](https://simplestatistics.org/docs/#ckmeans) clustering algorithm on a randomly sampled subset of data. This algorithm helps generate clusters more quickly.
...
- Allows you to create frequency entries in any order. Previous R5 versions would return an error if frequency entries were not ordered by their start time (see [#569](https://github.com/conveyal/r5/pull/563)). 
