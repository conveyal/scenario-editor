 ...
 */
export const GTFS_STOP_COLOR = '#c92336'
export const AUTO_CREATED_STOP_COLOR = '#888'
export const CONTROL_POINT_COLOR = '#2389c9'
export const HIGHLIGHT_SEGMENT_COLOR = '#c96323'
export const NEW_LINE_COLOR = '#2389c9'
export const NEW_SNAPPED_STOP_COLOR = '#c92336'
export const NEW_STOP_COLOR = '#2389c9'
